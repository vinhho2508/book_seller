...
function bookCreate(title, summary, isbn, author,pic, genre, cb) {
  bookdetail = { 
    title: title,
    summary: summary,
    author: author,
...
function bookInstanceCreate(book, imprint, amount, d_import, cb) {
  bookinstancedetail = { 
    book: book,
    imprint: imprint,
    amount:amount
  ...
  if(d_import!=false) bookinstancedetail.import_date=d_import
...
function createGenreAuthors(cb) {
    async.parallel([
        function(callback) {
          authorCreate('Patrick', 'Rothfuss','./pics/JKROWLING.jpg', '1973-06-06', false, callback);
        },
        function(callback) {
          authorCreate('Ben', 'Bova','./pics/JKROWLING.jpg', '1932-11-8', false, callback);
        },
        function(callback) {
          authorCreate('Isaac', 'Asimov','./pics/JKROWLING.jpg', '1920-01-02', '1992-04-06', callback);
        },
        function(callback) {
          authorCreate('Bob', 'Billings','./pics/JKROWLING.jpg', false, false, callback);
        },
        function(callback) {
          authorCreate('Jim', 'Jones','./pics/JKROWLING.jpg', '1971-12-16', false, callback);
        },
        function(callback) {
...
function createBooks(cb) {
    async.parallel([
        ...
        function(callback) {
          bookCreate('Test Book 1', 'Summary of test book 1', 'ISBN111111', authors[4],'./pics/Harry1.jpg', [genres[0],genres[1]], callback);
        },
        function(callback) {
          bookCreate('Test Book 2', 'Summary of test book 2', 'ISBN222222', authors[4],'./pics/Harry1.jpg', false, callback)
        }
        ],
        // optional callback
        cb);
...
function createBookInstances(cb) {
    async.parallel([
        function(callback) {
          bookInstanceCreate(books[0], 'London Gollancz, 2014.', 10, '2018-1-28', callback)
        },
        function(callback) {
          bookInstanceCreate(books[1], ' Gollancz, 2011.', 5, '2017-12-12', callback)
        },
        function(callback) {
          bookInstanceCreate(books[2], ' Gollancz, 2015.', 1, '2015-12-25', callback)
        },
        function(callback) {
          bookInstanceCreate(books[3], 'New York Tom Doherty Associates, 2016.', 10, '2016-05-13', callback)
        },
        function(callback) {
          bookInstanceCreate(books[3], 'New York Tom Doherty Associates, 2016.', 3, '2017-07-07', callback)
        },
        function(callback) {
          bookInstanceCreate(books[3], 'New York Tom Doherty Associates, 2016.', 2, '2016-05-13', callback)
        },
        function(callback) {
          bookInstanceCreate(books[4], 'New York, NY Tom Doherty Associates, LLC, 2015.', 5, '2017-07-07', callback)
        },
        function(callback) {
          bookInstanceCreate(books[4], 'New York, NY Tom Doherty Associates, LLC, 2015.', 7, '2015-12-25', callback)
        },
        function(callback) {
          bookInstanceCreate(books[4], 'New York, NY Tom Doherty Associates, LLC, 2015.', 4, '2016-05-13', callback)
        },
        function(callback) {
          bookInstanceCreate(books[0], 'Imprint XXX2', 4, '2017-07-07', callback)
        },
        function(callback) {
          bookInstanceCreate(books[1], 'Imprint XXX3', 5, '2016-05-13', callback)
        }
        ],
        // Optional callback
        cb);
